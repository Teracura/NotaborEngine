...
-  ### Mat4
  ...
  - #### funcations
    ...
    - `func (m Mat4) isTranslationOnly() bool` Checks matrix represents pure translation only
    - `func (m Mat4) isScaleOnly() bool` Checks matrix represents pure scaling, no rotation or translation
    - `func bottomRow0001Check(m Mat4, eps float32) bool` Checks matrix bottom row equals [0, 0, 0, 1] approximately
    - `func offDiagonalZeroCheck(m Mat4, eps float32) bool` Checks matrix off‑diagonal elements are approximately zero
    ...
    - `func floatEqual(a, b, eps float32) bool` Compares floats within epsilon tolerance
